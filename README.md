...
```bash
git clone https://github.com/deekshith-8/docmind-ai.git
...
Generate grounded response using LLaMA
...
Traditional LLMs rely solely on pre-trained knowledge, which can become outdated or generate inaccurate information.

Retrieval-Augmented Generation improves reliability by:

- Retrieving information directly from uploaded documents
- Reducing hallucinations
- Providing transparent citations
- Supporting domain-specific knowledge without fine-tuning
